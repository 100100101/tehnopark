...
$ui-switch-height           : /*rem-calc(32px) !default*/30px;

$ui-switch-thumb-size       : /*rem-calc(20px) !default*/20px;
$ui-switch-thumb-color      : $md-grey-50 !default;

$ui-switch-track-width      : /*rem-calc(34px) !default*/28px;
$ui-switch-track-height     : /*rem-calc(14px) !default*/18px;
