<template>
  ...
  <!-- @click="function($event) {
    ...
    <!--передача данных в ограниченную область видимости родительскому компоненту-->
    <slot
			name="default"
			:active="/*активен ли триггер*/active"
		/>
    <!---->
    ...
    <effect
      ...
      :is-centred="effectSettings.isCentred"
    />
  </div>
...
module.exports = {
  ...
  methods: {
    ...
    activate() {
      ...
      /**/
      // this.model.activeList.push(this.name);
    },
    ...
    deactivate() {
      ...
      /**/
      // let
      //   activeAmong = this.model.activeList.indexOf(this.name)
      // ;
      // if(!~activeAmong) {
      //   this.model.activeList.splice(this.name, 1);
      // }
    },
