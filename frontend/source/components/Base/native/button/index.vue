...
<script>
const
  config = require('../_static/config.js').default
;
...
export default {
    ...
    components: {
      'ui-icon': require('../icon/index.vue'),
      UiPopover: require('../popover/index.vue'),
      UiProgressCircular: require('../progress-circular/index.vue'),
      UiRippleInk: require('../ripple-ink/index.vue'),
    },
